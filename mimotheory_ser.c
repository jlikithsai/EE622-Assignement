...
/******************************************************************************/
/******************************************************************************/
/* Theoretical error-rate results for symbols in Rayleigh flat fading
...
int Open_File()
{
 if((CONSTELL == QAM16) && (NUM_RX == 1) && (NUM_TX == 1))
  fp=fopen("mimodata/qam16r1t1thser.dat","w");
 else if((CONSTELL == QAM16) && (NUM_RX == 2) && (NUM_TX == 1))
  fp=fopen("mimodata/qam16r2t1thser.dat","w");
  ...
  fp=fopen("mimodata/psk8r2t1thser.dat","w");
 else if((CONSTELL == PSK8) && (NUM_RX == 1) && (NUM_TX == 2))
  fp=fopen("mimodata/psk8r1t2thser.dat","w");
 else if((CONSTELL == PSK8) && (NUM_RX == 2) && (NUM_TX == 2))
  fp=fopen("mimodata/psk8r2t2thser.dat","w");
 else if((CONSTELL == BPSK) && (NUM_RX == 1) && (NUM_TX == 1))
  fp=fopen("mimodata/bpskr1t1thser.dat","w");
 else if((CONSTELL == BPSK) && (NUM_RX == 2) && (NUM_TX == 1))
  fp=fopen("mimodata/bpskr2t1thser.dat","w");
 else if((CONSTELL == BPSK) && (NUM_RX == 1) && (NUM_TX == 2))
  fp=fopen("mimodata/bpskr1t2thser.dat","w");
 else if((CONSTELL == BPSK) && (NUM_RX == 2) && (NUM_TX == 2))
  fp=fopen("mimodata/bpskr2t2thser.dat","w");
 else if((CONSTELL == QPSK) && (NUM_RX == 1) && (NUM_TX == 1))
  fp=fopen("mimodata/qpskr1t1thser.dat","w");
 else if((CONSTELL == QPSK) && (NUM_RX == 2) && (NUM_TX == 1))
  fp=fopen("mimodata/qpskr2t1thser.dat","w");
 else if((CONSTELL == QPSK) && (NUM_RX == 1) && (NUM_TX == 2))
  fp=fopen("mimodata/qpskr1t2thser.dat","w");
 else if((CONSTELL == QPSK) && (NUM_RX == 2) && (NUM_TX == 2))
  fp=fopen("mimodata/qpskr2t2thser.dat","w");
 else if((CONSTELL == QPSK) && (NUM_RX == 4) && (NUM_TX == 4))
  fp=fopen("mimodata/qpskr4t4thser.dat","w");
 else if((CONSTELL == QPSK) && (NUM_RX == 4) && (NUM_TX == 2))
  fp=fopen("mimodata/qpskr4t2thser.dat","w");
 else if((CONSTELL == QPSK) && (NUM_RX == 4) && (NUM_TX == 1))
  fp=fopen("mimodata/qpskr4t1thser.dat","w");
 if(fp == NULL)
...
{
 if((CONSTELL == QAM16) && (NUM_RX == 1) && (NUM_TX == 1))
  fp2=fopen("mimodata/qam16r1t1chser.dat","w");
 else if((CONSTELL == QAM16) && (NUM_RX == 2) && (NUM_TX == 1))
  fp2=fopen("mimodata/qam16r2t1chser.dat","w");
 else if((CONSTELL == QAM16) && (NUM_RX == 1) && (NUM_TX == 2))
  ...
  fp2=fopen("mimodata/psk8r2t1chser.dat","w");
 else if((CONSTELL == PSK8) && (NUM_RX == 1) && (NUM_TX == 2))
  fp2=fopen("mimodata/psk8r1t2chser.dat","w");
 else if((CONSTELL == PSK8) && (NUM_RX == 2) && (NUM_TX == 2))
  fp2=fopen("mimodata/psk8r2t2chser.dat","w");
 else if((CONSTELL == BPSK) && (NUM_RX == 1) && (NUM_TX == 1))
  fp2=fopen("mimodata/bpskr1t1chser.dat","w");
 else if((CONSTELL == BPSK) && (NUM_RX == 2) && (NUM_TX == 1))
  fp2=fopen("mimodata/bpskr2t1chser.dat","w");
 else if((CONSTELL == BPSK) && (NUM_RX == 1) && (NUM_TX == 2))
  fp2=fopen("mimodata/bpskr1t2chser.dat","w");
 else if((CONSTELL == BPSK) && (NUM_RX == 2) && (NUM_TX == 2))
  fp2=fopen("mimodata/bpskr2t2chser.dat","w");
 else if((CONSTELL == QPSK) && (NUM_RX == 1) && (NUM_TX == 1))
  fp2=fopen("mimodata/qpskr1t1chser.dat","w");
 else if((CONSTELL == QPSK) && (NUM_RX == 2) && (NUM_TX == 1))
  fp2=fopen("mimodata/qpskr2t1chser.dat","w");
 else if((CONSTELL == QPSK) && (NUM_RX == 1) && (NUM_TX == 2))
  fp2=fopen("mimodata/qpskr1t2chser.dat","w");
 else if((CONSTELL == QPSK) && (NUM_RX == 2) && (NUM_TX == 2))
  fp2=fopen("mimodata/qpskr2t2chser.dat","w");
 else if((CONSTELL == QPSK) && (NUM_RX == 4) && (NUM_TX == 4))
  fp2=fopen("mimodata/qpskr4t4chser.dat","w");
 else if((CONSTELL == QPSK) && (NUM_RX == 4) && (NUM_TX == 2))
  fp2=fopen("mimodata/qpskr4t2chser.dat","w");
 else if((CONSTELL == QPSK) && (NUM_RX == 4) && (NUM_TX == 1))
  fp2=fopen("mimodata/qpskr4t1chser.dat","w");
 if(fp2 == NULL)
  fprintf(stderr,"Directory does not exist. Exit.\n\n");
 return(0);
}
